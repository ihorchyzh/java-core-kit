 ...
 */
class MagicInvokeParameterisedMethod extends Statement {
    ...
    MagicInvokeParameterisedMethod(FrameworkMethod testMethod, Object testClass, Object params, int paramSetIdx) {
        this.testMethod = testMethod;
        this.testClass = testClass;
        this.uniqueMethodId = MagicUtils.uniqueMethodId(paramSetIdx - 1, params, testMethod.getName());
        try {
    ...
    private Object[] castParamsFromString(String params) throws ConversionFailedException {
        Object[] columns = null;
        try {
            columns = MagicUtils.splitAtCommaOrPipe(params);
    ...
    private Object[] castParamsFromObjects(Object params) throws ConversionFailedException {
        Object[] paramset = MagicUtils.safelyCastParamsToArray(params);
