...
// but we will use earthier solution
    ...
    private static final String INPUT_DATA = "src/test/resources/lesson5Data/input.txt";
    private static final String EXPECTED_RESULTS = "src/test/resources/lesson5Data/expected.txt";
