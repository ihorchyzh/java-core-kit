...
public class Lesson4Test {
    ...
    public void circleAreaTest() throws Exception {
        ...
        double delta = 0.01;
        Assert.assertEquals(expResult, lesson4.circleArea(radius), delta);
    }
    ...
    public void calculateBiggerCircleAreaEqualTest() throws Exception {
        ...
        Assert.assertEquals(expResult, lesson4.calculateBiggerCircleArea(firstCircleArea, secondCircleArea));
    }
    ...
    public void isRightAngledTriangleTrue1Test() throws Exception {
        ...
        Assert.assertEquals(expResult, lesson4.isRightAngledTriangle(sideA, sideB, sideC));
    }
    ...
    public void evenOrOddIsEvenTest() throws Exception {
        ...
        Assert.assertEquals(expResult, lesson4.evenOrOdd(number));
    }
    ...
    public void isBiggerEqualTest() throws Exception {
        ...
        Assert.assertEquals(expResult, lesson4.isBigger(firstNumber, secondNumber));
    }
